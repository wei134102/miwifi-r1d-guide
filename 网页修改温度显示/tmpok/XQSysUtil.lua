...
function setInited()
    ...
    --set wps state
    local hardware = getHardware()
    if hardware and hardware == "R3D" then
...
CST_1 = {
    "(UTC+1)阿姆斯特丹,柏林,伯尔尼,罗马,斯德歌尔摩,维也纳",
    "(UTC+1)贝尔格莱德,布拉迪斯拉发,布达佩斯,卢布尔雅那",
    "(UTC+1)布鲁塞尔,哥本哈根,马德里,巴黎",
    "(UTC+1)萨拉热窝,斯科普里,华沙,萨格勒布",
    "(UTC+1)温得和克",
    "(UTC+1)中非西部"
}
